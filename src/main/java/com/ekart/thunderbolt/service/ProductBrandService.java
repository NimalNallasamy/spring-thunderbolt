...
public class ProductBrandService {
    ...
    public List<ProductBrandDO> getAllProductBrands(){
    ...
    @Transactional
    public ProductBrandDO patchProducts(Long brandId, ProductBrandDO productBrandDO){
    ...
    @Transactional(readOnly = true)
    public ProductBrandDO getProductBrandById(Long brandId){
    ...
    @Transactional(readOnly = true)
    public ProductBrandDO getProductBrandByName(String brandName){
    ...
    @Transactional
    public ProductBrandDO saveProductBrand(ProductBrandDO productBrandDO){
        LOGGER.info("Inside ProductBrandService");
        LOGGER.info("Products Brand DO in Products Service ::: "+productBrandDO.toString());
        ProductBrand savedProductBrand = productBrandRepository.save(productBrandMapper.mapToDBData(productBrandDO));
